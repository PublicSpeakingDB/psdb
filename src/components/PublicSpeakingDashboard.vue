  ...
  methods: {
    ...
    summarizeData: function () {
      ...
      const params = {
        ...
        prompt:
          "Sumarize the following data. The data was generated by tracking the facial emotions, words spoken, and volume of the person deliverying the speech. The data is structured as JSON and represents values for speech rate, words spoken, facial emotions, and word complexity, sampled every second during the speech. Explain to the speaker their speech dynamics. Data: " +
          instance.dataSample,
        temperature: 0,
        max_tokens: 1500,
        top_p: 1,
      ...
      client
        ...
        .then((result) => {
          ...
          instance.dataSummary = instance.dataSummary += rawResultA;
    ...
    getFeedback: function () {
      ...
      const params = {
        ...
        prompt:
          "Give an overall summary that synthesizes the data and feedback contained in the following statements. Statements: " +
